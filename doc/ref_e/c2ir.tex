...
cepstrum contained in the input file {\em infile}.
If the input file name is omitted, the standard input is used.
...
\begin{options}
	...
	\desc{If the number of cepstrum coefficients $M_1$ is not
             assigned and the order of the cepstrum analysis
