...
\begin{qsection}{DESCRIPTION}
        This command undertakes the adaptive generalized
        cepstrum analysis\cite{ref:agcep-IEICEtaikai90s},
        sends the cepstrum coefficients $c_\gamma(m)$ to the standard output,
