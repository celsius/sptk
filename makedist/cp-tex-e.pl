...
execute("cp $opt_b/doc/ref_e/cmndref.sty $opt_d");
execute("cp $opt_b/doc/ref_e/ref.tex $opt_d");

# modify Makefile and main.tex
print "$opt_b/doc/ref_e/Makefile -> $opt_d/Makefile\n"
	if ( ( $opt_n == 1 ) || ( $opt_v == 1 ) );
if ( $opt_n == undef ) {
	open(MAKEIN, "$opt_b/doc/ref_e/Makefile") || die "cannot open $opt_b/doc/ref_e/Makefile";
...
print "$opt_b/doc/ref_e/main.tex -> $opt_d/main.tex\n"
	if ( ( $opt_n == 1 ) || ( $opt_v == 1 ) );
if ( $opt_n == undef ) {
	open(MAININ, "$opt_b/doc/ref_e/main.tex") || die "cannot open $opt_b/doc/ref_e/main.tex";
...
while ( $x = <FILE> ) {
	...
	# standard files
	execute("cp $opt_b/doc/ref_e/$x.tex $opt_d");
